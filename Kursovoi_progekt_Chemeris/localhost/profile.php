        ...
        <table bgcolor="#FFFFFF"
            ...
            <tr>
                <td style="width:50%" align="center">
                    ...
                    <img src="image/01.jpg" width="550" height="500">
                </td>
                ...
                <td rowspan="1"
                    style="width:50%">
                    <h1>
                        <p style="text-indent: 60px; padding: 25px;">
                            • На нашем сайте вы можете найти интернет книги которые вы можете
                            почитать даже в офлайн режиме для этого приобретите VIP версию или
                            возьмите в аренду.
                        </p>
                        ...
                        <p style="text-indent: 60px; padding: 25px;">
                            • Мы постоянно пытаемся улучшить работу нашего сервиса, а так же
                            вы можете арендовать книгу, и можете читать ее на разных устройствах.
                        </p>

                        <p style="text-indent: 60px; padding: 25px;">
                            • На этом сайте вы можете найти большой каталог интересующих вас книг.
                        </p>
                    </h1>
                </td>
        </table>
        ...
        <table bgcolor="#c5c5e0"
            ...
            <tr>
                <td bgcolor="#87CEEB"
                    ...
                    <h1>Здесь поинтересоваться по поводу сайта</h1>
                    <p>
                    <h1>И написать комментарий на этот сайт.</h1>
                    <p>
                ...
                <td bgcolor="#87CEEB"
                    align="center"
                    style="width: 30%; border-radius: 20px; margin: auto; ">
                    <h1>Почта на email : Glebchemeris@mail.ru</h1>
                    <p>
                </td>
            </tr>
        </table>
